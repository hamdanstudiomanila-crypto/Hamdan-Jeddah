...
- Leave credits: Jeddah does not use leave credits; requests, including past dates, remain subject to HR review.
...
- HR workflow overview: HR tools generally cover attendance review, disputes, leave review, payslip publishing, employee directory, team leave calendar, and HR support. Employees must not receive HR-only private records.
