...
Effective September 1, 2026, the working week is Sunday through Thursday, 8:00 AM to 6:00 PM, in `Asia/Riyadh` (UTC+3). Time-in after 8:00 AM is late, with no grace period. Friday and Saturday are rest days.
...
- Records before September 1 are preserved. September 1-7 attendance is reconciled to the revised start date; rest-day absences are removed and missing eligible Sunday absences are generated. Dates before September 1 retain the previous Monday-Friday workweek and previous late cutoff for calculations.
...
The follow-up migration `20260909015106_jeddah_schedule_from_september_first.sql` moves the effective date to September 1 as requested. No leave allocations existed for September 1-7 when this correction was checked.
