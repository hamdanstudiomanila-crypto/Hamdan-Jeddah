...
export default function EmployeeDashboard() {
  ...
  return (
    ...
    >
      ...
      {myDisputesModalOpen && <AttendanceDisputesModal open={myDisputesModalOpen} onClose={() => setMyDisputesModalOpen(false)} cancelDispute={cancelDispute} cancelingDisputeId={cancelingDisputeId} disputeClaimed={disputeClaimed} disputeFieldLabel={disputeFieldLabel} disputeOriginal={disputeOriginal} disputeTypeLabel={disputeTypeLabel} formatDisputeTimePh={formatDisputeTimePh} myDisputes={myDisputes} openDisputeModal={(logId, date, type, locked) => { setMyDisputesModalOpen(false); openDisputeModal(logId, date, type, locked); }} selectedMyDisputeDetail={selectedMyDisputeDetail} setSelectedMyDisputeDetail={setSelectedMyDisputeDetail} />}
