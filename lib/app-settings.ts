...
const APP_SETTING_DEFINITIONS_SOURCE: AppSettingDefinition[] = [
  numberSetting({ key: 'late_cutoff_hour', category: 'attendance', label: 'Late Cutoff Hour', description: 'Time-ins after this Jeddah hour are marked Late. Applies to new Time Ins immediately.', defaultValue: 8, min: 0, max: 23, unit: 'hour', status: 'active' }),
  numberSetting({ key: 'late_cutoff_minute', category: 'attendance', label: 'Late Cutoff Minute', description: 'Minute component of the active Late cutoff. Applies to new Time Ins immediately.', defaultValue: 0, min: 0, max: 59, unit: 'minute', status: 'active' }),
  numberSetting({ key: 'time_out_reminder_hour', category: 'attendance', label: 'Time-Out Reminder', description: 'Starts the Employee time-out reminder at this Jeddah hour.', defaultValue: 18, min: 0, max: 23, unit: 'hour', status: 'active' }),
  ...
  numberSetting({ key: 'work_start_hour', category: 'attendance', label: 'Work Start Hour', description: 'Sunday to Thursday work starts at this Jeddah hour.', defaultValue: 8, min: 0, max: 23, unit: 'hour', status: 'future' }),
  numberSetting({ key: 'work_start_minute', category: 'attendance', label: 'Work Start Minute', description: 'Minute component of the Jeddah work schedule.', defaultValue: 0, min: 0, max: 59, unit: 'minute', status: 'future' }),
  numberSetting({ key: 'work_end_hour', category: 'attendance', label: 'Work End Hour', description: 'Sunday to Thursday work ends at this Jeddah hour.', defaultValue: 18, min: 0, max: 23, unit: 'hour', status: 'future' }),
  numberSetting({ key: 'work_end_minute', category: 'attendance', label: 'Work End Minute', description: 'Minute component of the Jeddah work schedule.', defaultValue: 0, min: 0, max: 59, unit: 'minute', status: 'future' }),
